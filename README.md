...
## Overview
This experiment uses Terraform to create a single virtual machine on [Digital Ocean's cloud](https://cloud.digitalocean.com/).  It is part of a series of experiments begun in early 2026.  I have structured the Terraform files with sequence numbers to show the logical flow of resource creation.  Roughly the sequence is:
...
* Step 7 - [Digital Ocean](https://github.com/andrew-siwko/terraform-digital-ocean-test) (you are here)
...
* Project stats:
  ...
  * Hurdles: 
    * TBD
<br/>
I had a hard time finding the free trial.  If you want a free trial of Digital Ocean you should be able to get the $200 credit here:[![DigitalOcean Referral Badge](https://web-platforms.sfo2.cdn.digitaloceanspaces.com/WWW/Badge%201.svg)](https://www.digitalocean.com/?refcode=fd6adbc0ccc5&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge)
